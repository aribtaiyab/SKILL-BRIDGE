...
import { StudentDashboardData, SkillOverviewItem, CareerTargetOption, SkillCategoryGroup } from '@/types'
import { calculateOverallReadiness } from '@/lib/intelligence/engine'
